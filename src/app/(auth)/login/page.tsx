      ...
      <div className="container relative z-10 flex min-h-screen flex-col items-center justify-center px-4 md:px-6">
        ...
        <Card className="w-full max-w-sm text-center shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Sign in to access your personalized health plan and more.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Button className="w-full shadow-sm" variant="outline" onClick={handleGoogleSignIn}>
              <GoogleIcon />
              <span className="ml-2">Sign in with Google</span>
            </Button>
            <Button className="w-full shadow-sm" variant="outline" disabled>
